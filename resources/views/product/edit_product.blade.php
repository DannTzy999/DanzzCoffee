                        ...
                        <div class="row">
                          <div class="col mb-3">
                            <div class="form-group">
                              ...
                              <textarea class="form-control @error('orientation') is-invalid @enderror" id="orientation"
                                name="orientation" placeholder="Enter product orientation" rows="4">{{ old('orientation', $product->orientation) }}</textarea>
                              @error('orientation')
                              <div class="text-danger">{{ $message }}</div>
                              @enderror
                            </div>
                          ...
                          <div class="col mb-3">
                            <div class="form-group">
                              ...
                              <textarea class="form-control @error('description') is-invalid @enderror" id="description" 
                                name="description" placeholder="Masukkan description produk" rows="4">{{ old('description', $product->description) }}</textarea>
                              @error('description')
                              <div class="text-danger">{{ $message }}</div>
                              @enderror
                            </div>
