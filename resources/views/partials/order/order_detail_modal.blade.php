                  ...
                  <tr id="row_qr_code">
                    <td colspan="2">
                      <div class="d-flex flex-column align-items-center text-center">
                        <span class="heading d-block mb-2">QR Code Payment</span>
                        <img id="qr_code_detail" src="{{ asset('storage/qr-code.png') }}" alt="QR Code Payment" width="180px" class="rounded border">
                        <small class="text-muted mt-2" style="display: block; margin-top: 8px;">Scan QR code dengan aplikasi pembayaran Anda</small>
                      </div>
                    </td>
                  </tr>
