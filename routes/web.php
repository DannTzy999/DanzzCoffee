...
use App\Http\Controllers\{AuthController, HomeController, OrderController, PointController, ReviewController, ProductController, ProfileController, TransactionController};
...
// Email Verification Link Handler (unauthenticated)
Route::get('/email/verify/{id}/{hash}', function (CustomEmailVerificationRequest $request) {
    $request->fulfill();

    myFlasherBuilder(message: 'Email Anda berhasil diverifikasi! Silakan login.', success: true);
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get("/home/customers", [HomeController::class, "customers"])->can("is_admin")->name("home.customers");
    ...
    Route::controller(OrderController::class)->group(function () {
        Route::get("/order/order_data", "orderData")->name("order.index");
