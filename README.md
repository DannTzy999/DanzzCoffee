...
DanzzCoffee is a web application built using the Laravel framework that allows users to browse and order coffee products online.
...
To run DanzzCoffee locally, follow these steps:

1. Clone this repository:

   ```bash
   git clone https://github.com/DannTzy999/DanzzCoffee.git
   ```
...
## License
This project is licensed under the [MIT License](https://github.com/DannTzy999/DanzzCoffee/blob/master/LICENSE).
