    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response["payment"]["payment_method"] == "COD") {
                ...
                $("#row_qr_code").css("display", "none");
            } else if (response["payment"]["payment_method"] == "Transfer QR") {
                // tampilkan QR code untuk Transfer QR
                $("#modal_section_payment_proof").css("display", "unset");
                $("#row_bank").css("display", "none");
                $("#row_qr_code").css("display", "table-row");
            } else {
                // to restore undisplayed elements (for other payment methods)
                $("#modal_section_payment_proof").css("display", "unset");
